...
- `clap` for the command line, Serde plus `yaml_serde` for manifests, `sha1` for legacy track identity, `crc` for CD-ROM EDC, native safe-Rust ECC handling, and Rayon for parallel sector protection.
